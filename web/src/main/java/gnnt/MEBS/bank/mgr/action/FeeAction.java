  ...
  extends EcsideAction
{
  ...
  public String setUpBankFeeForward()
  {
    ...
    PageRequest<QueryConditions> dicpageRequest = new PageRequest(1, 100, dicqc, " order by id ");
    Page<StandardModel> dicPage = getService().getPage(dicpageRequest, new Dictionary());
    ...
    PageRequest<QueryConditions> feepageRequest = new PageRequest(1, 100, feeqc, " order by id ");
    Page<StandardModel> feePage = getService().getPage(feepageRequest, new FeeInfo());
  ...
  public String setUpBankFee()
  {
    ...
    feeqc.addCondition("type", "=", type);
    feeqc.addCondition("userID", "=", bankID);
    PageRequest<QueryConditions> feepageRequest = new PageRequest(1, 100, feeqc);
    Page<StandardModel> feePage = getService().getPage(feepageRequest, new FeeInfo());
