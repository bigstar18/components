  ...
  extends EcsideAction
{
  ...
  {
    PageRequest<QueryConditions> pageRequest = new PageRequest(1, 100, new QueryConditions());
    ...
    if ((page != null) && (page.getResult() != null))
    {
      ...
      for (StandardModel sm : page.getResult())
      {
        Bank bank = (Bank)sm;
  ...
  public String getErrorCapitalInfo()
  {
    ...
    try
    {
      List<CompareResult> list = this.capitalProcessorRMI.checkMoney(bankID, s_time);
      if (list == null)
      {
