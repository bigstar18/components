...
public class AjaxCheckBroker extends BaseAjax {
	...
	public String mouseCheckBrokerBrokerId() {
		...
		String s = httpservletrequest.getParameter("fieldId");
		String s1 = httpservletrequest.getParameter("fieldValue");
		jsonValidateReturn = createJSONArray(new Object[] { s, Boolean.valueOf(!existBrokerBrokerId(s1)) });
		return "success";
	}
