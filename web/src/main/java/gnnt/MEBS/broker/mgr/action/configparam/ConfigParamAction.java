  ...
  extends EcsideAction
{
  ...
  public boolean getExistValidate()
  {
    return this.existValidate;
  }
    ...
    throws Exception
  {
    ...
    if (ids != null)
    {
      Collection<StandardModel> deleteList = new ArrayList();
    ...
    throws Exception
  {
    ...
    List<Map<Object, Object>> list1 = getService().getListBySql(sql1);
