  ...
  extends StandardModel
{
  ...
  @ClassDiscription(name="仓单状态", description="仓单状态： 0:未注册仓单  1：注册仓单  2：已出库仓单  3：已拆单 4：拆仓单处理中 5：出库申请中")
  ...
  public StockOutApplyBO getStockOutApplyBO()
  {
    StockOutApplyBO localStockOutApplyBO = new StockOutApplyBO();
    localStockOutApplyBO.setStockID(getStockId());
    return localStockOutApplyBO;
  }
