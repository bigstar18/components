  ...
  implements LogonCallbak
{
  ...
  public void logonSuccessCallbak(User paramUser, HttpServletRequest paramHttpServletRequest)
  {
    try
    {
      TraderLogonInfo localTraderLogonInfo = this.tradeRMI.remoteLogon(paramUser.getTraderID(), paramUser.getSessionId().longValue(), paramUser.getIpAddress(), "web", 15, "web", 15);
