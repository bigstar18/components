...
public class DelayTradeDaoImpl
  extends StandardDao
  implements DelayTradeDao
{
  public gnnt.MEBS.timebargain.server.model.DelayOrder getDelayOrderById(String paramString)
  {
    ...
    try
    {
      gnnt.MEBS.timebargain.front.model.DelayOrder localDelayOrder1 = (gnnt.MEBS.timebargain.front.model.DelayOrder)getHibernateTemplate().get(gnnt.MEBS.timebargain.front.model.DelayOrder.class, Long.valueOf(paramString));
