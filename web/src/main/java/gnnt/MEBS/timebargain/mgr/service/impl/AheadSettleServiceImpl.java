  ...
  implements AheadSettleService
{
  ...
  public int addApplyAheadSettle(String[] ids, ApplyAheadSettle applyAheadSettle, String firmB, String firmS)
    throws Exception
  {
    int result = 0;
    
    List<Map<Object, Object>> bHoldQtyList = this.aheadSettleDao.queryBySql("select (holdqty-frozenqty) qty from t_customerholdsum where CustomerID ='" + applyAheadSettle.getCustomerId_B() + "' and CommodityID= '" + applyAheadSettle.getCommodityId() + "' and bs_flag = 1");
    ...
    List<Map<Object, Object>> sHoldQtyList = this.aheadSettleDao.queryBySql("select (holdqty-frozenqty) qty from t_customerholdsum where CustomerID ='" + applyAheadSettle.getCustomerId_S() + "' and CommodityID= '" + applyAheadSettle.getCommodityId() + "' and bs_flag = 2");
    ...
    List<Map<Object, Object>> list = this.aheadSettleDao.queryBySql(sql);
  ...
  public int auditApplyAheadSettlePass(ApplyAheadSettle applyAheadSettle)
    throws Exception
  {
    int result = 0;
  ...
  public int auditApplyAheadSettleFail(ApplyAheadSettle applyAheadSettle)
    throws Exception
  {
    int result = 1;
