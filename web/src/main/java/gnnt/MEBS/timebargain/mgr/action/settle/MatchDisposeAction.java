...
@Scope("request")
public class MatchDisposeAction
  extends EcsideAction
{
    ...
    throws Exception
  {
    ...
    List<Map<Object, Object>> priceList = getService().getListBySql(sql);
    this.request.setAttribute("priceList", priceList);
    Page<Map<Object, Object>> page = new Page(1, 15, priceList.size(), priceList);
    ...
    throws Exception
  {
    ...
    List<Map<Object, Object>> billList = getService().getListBySql(sql);
    this.request.setAttribute("billList", billList);
    Page<Map<Object, Object>> page = new Page(1, 15, billList.size(), billList);
    this.request.setAttribute("pageInfo", page);
    return "success";
  }
