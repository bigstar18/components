...
public class DeletesListInterceptor
  extends AbstractInterceptor
{
  ...
  private List<StandardModel> createList(HttpServletRequest paramHttpServletRequest, ActionInvocation paramActionInvocation)
    throws Exception
  {
