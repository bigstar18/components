  ...
  extends Apply
{
  ...
  public void generationContent()
  {
    ...
    feeAlgrElement.setText(getFeeAlgr() != null ? getFeeAlgr() : "0");
    Element feeRate_BElement = booksElement.addElement("feeRate_B");
    feeRate_BElement.setText(getFeeRate_B() != "0" ? getFeeRate_B() : "0");
    Element feeRate_SElement = booksElement.addElement("feeRate_S");
    feeRate_SElement.setText(getFeeRate_S() != "0" ? getFeeRate_S() : "0");
    
    Element historyCloseFeeRate_BElement = booksElement.addElement("historyCloseFeeRate_B");
    historyCloseFeeRate_BElement.setText(getHistoryCloseFeeRate_B() != null ? getHistoryCloseFeeRate_B() : "0");
    Element historyCloseFeeRate_SElement = booksElement.addElement("historyCloseFeeRate_S");
    historyCloseFeeRate_SElement.setText(getHistoryCloseFeeRate_S() != null ? getHistoryCloseFeeRate_S() : "0");
    
    Element todayCloseFeeRate_BElement = booksElement.addElement("todayCloseFeeRate_B");
    todayCloseFeeRate_BElement.setText(getTodayCloseFeeRate_B() != "0" ? getTodayCloseFeeRate_B() : "0");
    Element todayCloseFeeRate_SElement = booksElement.addElement("todayCloseFeeRate_S");
    todayCloseFeeRate_SElement.setText(getTodayCloseFeeRate_S() != "0" ? getTodayCloseFeeRate_S() : "0");
    
    Element forceCloseFeeRate_BElement = booksElement.addElement("forceCloseFeeRate_B");
    forceCloseFeeRate_BElement.setText(getForceCloseFeeRate_B() != "0" ? getForceCloseFeeRate_B() : "0");
    Element forceCloseFeeRate_SElement = booksElement.addElement("forceCloseFeeRate_S");
    forceCloseFeeRate_SElement.setText(getForceCloseFeeRate_S() != "0" ? getForceCloseFeeRate_S() : "0");
    
    Element settleFeeAlgrElement = booksElement.addElement("settleFeeAlgr");
    settleFeeAlgrElement.setText(getSettleFeeAlgr() != null ? getSettleFeeAlgr() : "0");
    Element settleFeeRate_BElement = booksElement.addElement("settleFeeRate_B");
    settleFeeRate_BElement.setText(getSettleFeeRate_B() != "0" ? getSettleFeeRate_B() : "0");
    Element settleFeeRate_SElement = booksElement.addElement("settleFeeRate_S");
    settleFeeRate_SElement.setText(getSettleFeeRate_S() != "0" ? getSettleFeeRate_S() : "0");
    
    Element lowestSettleFeeElement = booksElement.addElement("lowestSettleFee");
    lowestSettleFeeElement.setText(getLowestSettleFee());
