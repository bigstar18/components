  ...
  extends JdbcDaoSupport
{
  ...
  public Apply getApplyById(Apply apply, boolean lock)
  {
    ...
    String sql = "select id, applytype, status, proposer, applytime, approver, approvetime, note from t_apply t where id=" + 
      id + " " + filter;
  ...
  public void updateCommodityFee(Apply_T_CommodityFee app)
  {
    ...
    Object[] params = {
      ...
      app.getFeeRate_B(), 
      app.getFeeRate_S(), 
      app.getHistoryCloseFeeRate_B(), 
      app.getHistoryCloseFeeRate_S(), 
      app.getTodayCloseFeeRate_B(), 
      app.getTodayCloseFeeRate_S(), 
      app.getForceCloseFeeRate_B(), 
      app.getForceCloseFeeRate_S(), 
      app.getSettleFeeAlgr(), 
      app.getSettleFeeRate_B(), 
      app.getSettleFeeRate_S(), 
      app.getLowestSettleFee(), 
      app.getCommodityID() };
  ...
  public void updateCommodityMargin(Apply_T_CommodityMargin app)
  {
    ...
    Object[] params = {
      ...
      app.getMarginItem4(), 
      app.getMarginItem5(), 
      app.getMarginItem1_S(), 
      app.getMarginItem2_S(), 
      app.getMarginItem3_S(), 
      app.getMarginItem4_S(), 
      app.getMarginItem5_S(), 
      app.getMarginItemAssure1(), 
      app.getMarginItemAssure2(), 
      app.getMarginItemAssure3(), 
      app.getMarginItemAssure4(), 
      app.getMarginItemAssure5(), 
      app.getMarginItemAssure1_S(), 
      app.getMarginItemAssure2_S(), 
      app.getMarginItemAssure3_S(), 
      app.getMarginItemAssure4_S(), 
      app.getMarginItemAssure5_S(), 
      app.getSettleMarginAlgr_B(), 
      app.getSettleMarginAlgr_S(), 
      app.getSettleMarginRate_B(), 
      app.getSettleMarginRate_S(), 
      app.getPayoutAlgr(), 
      app.getPayoutRate(), 
  ...
  public void updatePledge(Apply_T_PledgeMoney app)
  {
    ...
    Object[] params = {
      app.getBillID(), 
      Double.valueOf(app.getBillFund()), 
      app.getFirmId(), 
      app.getCommodityName(), 
      relQuantity, 
      app.getApprover(), 
      app.getApprover() };
