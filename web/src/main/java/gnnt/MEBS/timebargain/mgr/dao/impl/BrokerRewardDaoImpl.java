...
public class BrokerRewardDaoImpl
  extends StandardDao
  implements BrokerRewardDao
{
  ...
  public List getFirmRewardSum(String isPartition, String startBreed, String endBreed, String startFirm, String endFirm, String beginDate, String endDate)
  {
    ...
    if ((!"".equals(beginDate)) && (!"".equals(endDate)) && (beginDate != null) && (endDate != null)) {
      sql = 
        sql + "and a.cleardate >= to_date('" + beginDate + "','yyyy-MM-dd') " + "and a.cleardate <= to_date('" + endDate + "','yyyy-MM-dd')";
    }
    sql = sql + "order by a.firmid, a.brokerid, a.cleardate ";
    if ("N".equals(isPartition)) {
      sql = 
      
        "select d.firmid firmid, d.firmname firmname, d.brokerid brokerid, d.brokername brokername, d.cleardate cleardate, sum(d.sumTradeFee) sumTradeFee,sum(d.sumBrokereachdivide) sumBrokereachdivide,sum(d.sumReward) sumReward,sum(d.sumSelfGain) sumSelfGain,sum(d.sumMarhetGain) sumMarhetGain,sum(d.sumFinalMarhetGain) sumFinalMarhetGain from ( " + sql + " ) d " + "group by d.brokerid, d.brokername, d.firmid, d.firmname, d.cleardate " + "order by d.firmid, d.brokerid, d.cleardate desc ";
    } else if ("Y".equals(isPartition)) {
      sql = 
      
        "select d.firmid firmid, d.firmname firmname, d.brokerid brokerid, d.brokername brokername, d.cleardate cleardate, d.breedid breedid, sum(d.sumTradeFee) sumTradeFee,sum(d.sumBrokereachdivide) sumBrokereachdivide,sum(d.sumReward) sumReward,sum(d.sumSelfGain) sumSelfGain,sum(d.sumMarhetGain) sumMarhetGain,sum(d.sumFinalMarhetGain) sumFinalMarhetGain from ( " + sql + " ) d " + "group by d.brokerid, d.brokername, d.firmid, d.firmname, d.cleardate, d.breedid " + "order by d.firmid, d.brokerid, d.cleardate desc";
    }
    return queryBySql(sql);
  }
  ...
  public List getBrokerTradeFee(HttpServletRequest request)
  {
    ...
    if ((beginBroker != null) && (endBroker != null) && (!"".equals(beginBroker)) && 
      (!"".equals(endBroker))) {
      filter = 
        filter + " and s.brokerid >= '" + beginBroker + "'and s.brokerid <= '" + endBroker + "'";
    }
    ...
    if ((beginDate != null) && (endDate != null))
    {
      ...
      if ((!"".equals(beginDate)) && (!"".equals(endDate))) {
        filter = 
          ...
          filter + " and cleardate >= to_date('" + beginDate + "','yyyy-MM-dd') and cleardate <= to_date('" + endDate + "','yyyy-MM-dd')";
      }
    }
    sql = sql + filter;
  ...
  public List getBreedTradeFee(HttpServletRequest request)
  {
    ...
    if ((beginBreed != null) && (endBreed != null) && (!"".equals(beginBreed)) && 
      (!"".equals(endBreed))) {
      filter = 
        filter + "and s.breedid >= '" + beginBreed + "'and s.breedid <= '" + endBreed + " '";
    }
    String beginDate = request
      .getParameter("gnnt_primary.occurDate[>=][date]");
    String endDate = request
  ...
  public List getFirmTradeFee(HttpServletRequest request)
  {
    ...
    if ((beginFirm != null) && (endFirm != null) && (!"".equals(beginFirm)) && 
      (!"".equals(endFirm))) {
      filter = 
        filter + "and a.firmid >= '" + beginFirm + "' and a.firmid <= '" + endFirm + "'";
    }
    String beginDate = request
      .getParameter("gnnt_primary.occurDate[>=][date]");
    String endDate = request
  ...
  public List getBrokerUserFeeList(String startFirm, String endFirm, String beginDate, String endDate, String summarizingWay, String brokerid, String breedId)
  {
    ...
    if ("summarizingFirmAndSummarizing".equals(summarizingWay))
    {
      ...
      if ((!"".equals(beginDate)) && (!"".equals(endDate)) && (beginDate != null) && (endDate != null)) {
        sql = 
          sql + "and fb.cleardate >= to_date('" + beginDate + "','yyyy-MM-dd') " + "and fb.cleardate <= to_date('" + endDate + "','yyyy-MM-dd')";
      }
  ...
  public List getHisDealDetailList(String brokerId, String breedId, String firmId, String bsFlag, String beginDate, String endDate)
  {
    ...
    if ((!"".equals(beginDate)) && (!"".equals(endDate)) && (beginDate != null) && (endDate != null)) {
      sql = 
        sql + "and tr.cleardate >= to_date('" + beginDate + "','yyyy-MM-dd') " + "and tr.cleardate <= to_date('" + endDate + "','yyyy-MM-dd')";
    }
    return queryBySql(sql);
  }
}
