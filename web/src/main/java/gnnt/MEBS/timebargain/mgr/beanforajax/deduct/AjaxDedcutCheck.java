...
public class AjaxDedcutCheck
{
  ...
  private boolean existDeductKeep(Long deductId, Integer bs_Flag, String customerId)
  {
    ...
    PageRequest<String> pageRequest = new PageRequest(" and primary.deductId='" + deductId + "' and primary.bs_Flag=" + bs_Flag + " and primary.customerId='" + customerId + "'");
    Page<StandardModel> page = getService().getPage(pageRequest, new DeductKeep());
