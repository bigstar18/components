...
public class HistoryHoldPositionModel
  extends StandardModel
{
  private static final long serialVersionUID = 4582932586407212703L;
  @ClassDiscription(name="结算日期", description="")
  private Date clearDate;
  @ClassDiscription(name="持仓单号", description="")
  private Long holdNo;
  ...
  @ClassDiscription(name="持仓时间", description="")
  ...
  @ClassDiscription(name="动盈亏", description="")
