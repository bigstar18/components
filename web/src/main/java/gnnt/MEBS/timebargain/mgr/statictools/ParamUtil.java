...
public class ParamUtil
{
    ...
    throws SecurityException, Exception
  {
    ...
    else if ((cl == Integer.class) || (cl == Float.class) || (cl == Long.class) || (cl == Double.class) || (cl == Byte.class) || (cl == Boolean.class) || (cl == Character.class) || (cl == Short.class))
    {
  ...
  private static List<String> getParamNames(Object bean, Enumeration<String> em)
  {
    ...
    for (; em.hasMoreElements(); i < methods.length)
    {
      ...
      methodname = "set" + getFunName(name);
      i = 0; continue;
