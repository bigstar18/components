...
@Scope("request")
public class SettlePropsAction
  extends ECSideAction
{
  ...
  public String viewSettlePropsById()
    throws Exception
  {
  ...
  public String getPropertyValueByBreedID()
  {
    ...
    PageRequest localPageRequest = new PageRequest(" and primary.type='leaf'and primary.status=1 and primary.belongModule like '%15%' and primary.categoryId=" + l2);
