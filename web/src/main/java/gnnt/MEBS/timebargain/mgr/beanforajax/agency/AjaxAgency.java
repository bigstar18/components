...
@Scope("request")
public class AjaxAgency
  extends AjaxCheckDemo
{
  ...
  private boolean existModelId(Object value, StandardModel model)
  {
    ...
    List<StandardModel> page = getService().getListByBulk(model, 
      new Object[] { value });
  ...
  public String getCommodity()
  {
    ...
    if (marginAlgr.equals("1"))
    {
      comStr = 
        ...
        comStr + mul((commodity.getMarginRate_B() == null ? new Double(0.0D) : commodity.getMarginRate_B()).doubleValue(), 100.0F) + ",";
  ...
  public String getFirmMargin()
  {
    ...
    if (marginAlgr.equals("1"))
    {
      comStr = 
        ...
        comStr + mul((firmMargin.getMarginRate_B() == null ? new Double(0.0D) : firmMargin.getMarginRate_B()).doubleValue(), 100.0F) + ",";
      ...
      comStr = comStr + mul(
        ...
        firmMargin.getMarginAssure_B()).doubleValue(), 100.0F) + 
        ",";
      comStr = comStr + mul(
        (firmMargin.getMarginAssure_S() == null ? new Double(0.0D) : 
        firmMargin.getMarginAssure_S()).doubleValue(), 100.0F) + 
        ",";
