  ...
  extends AjaxCheckDemo
{
  ...
  public String getBill()
  {
    ...
    List<String> billIdList = this.kernelService.getUnusedStocks(15, firmid);
  ...
  public String getReBill()
  {
    ...
    List<Map<Object, Object>> billIdList = getService().getListBySql(sql);
    if ((billIdList != null) && (billIdList.size() > 0)) {
      for (int i = 0; i < billIdList.size(); i++) {
