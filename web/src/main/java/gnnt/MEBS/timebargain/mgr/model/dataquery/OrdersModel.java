...
{
  private static final long serialVersionUID = 7330504886742307341L;
  ...
  @ClassDiscription(name="交易商对象", description="")
  private MFirmModel mFirmModel;
  @ClassDiscription(name="指定转让委托对象", description="")
  private SpecFrozenHoldModel specFrozenHoldModel;
  ...
  public SpecFrozenHoldModel getSpecFrozenHoldModel()
  {
    return this.specFrozenHoldModel;
  }
  
  public void setSpecFrozenHoldModel(SpecFrozenHoldModel specFrozenHoldModel)
  {
    this.specFrozenHoldModel = specFrozenHoldModel;
  }
  ...
  {
    return new StandardModel.PrimaryInfo(this, "orderNo", this.orderNo);
  }
}
