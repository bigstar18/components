...
public class CustomerDAOJdbc extends BaseDAOJdbc implements CustomerDAO {
	...
	class CustomerFundsRowMapper implements RowMapper {
		...
		private CustomerFunds rsToCustomerFunds(ResultSet paramResultSet) throws SQLException {
	...
	class CustomerRowMapper implements RowMapper {
		...
		private Customer rsToCustomer(ResultSet paramResultSet) throws SQLException {
