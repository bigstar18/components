...
public class CommodityVO
{
  ...
  public String toString()
  {
    ...
    localStringBuffer.append("minAmount:" + this.minAmount + str);
    localStringBuffer.append("maxAmount:" + this.maxAmount + str);
    localStringBuffer.append("maxStepPrice:" + this.maxStepPrice + str);
