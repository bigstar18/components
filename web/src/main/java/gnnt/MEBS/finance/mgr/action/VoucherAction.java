...
public class VoucherAction extends EcsideAction {
	...
	public String addVoucher() throws Exception {
		...
		List<Map<Object, Object>> sqlList = getService().getListBySql("select seq_f_voucher.Nextval from dual");
	...
	public String addVoucherFastForward() {
		List<Map<Object, Object>> sqlList = getService().getListBySql(
	...
	public String updateAuditAll() throws Exception {
		...
		User user = (User) this.request.getSession().getAttribute("CurrentUser");
		List<Map<Object, Object>> sqlList = getService().getListBySql("select * from f_voucher where status='editing'");
