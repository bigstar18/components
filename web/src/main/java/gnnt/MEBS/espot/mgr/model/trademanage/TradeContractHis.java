  ...
  extends StandardModel
{
  ...
  private Set<TradeGoodsPropertyHis> tradeGoodsProperties;
  @ClassDiscription(name="关联订单", description="对应订单号")
  private Set<ReserveHis> belongToReserve;
  @ClassDiscription(name="关联持仓", description="对应持仓号")
  private Set<HoldingHis> belongToHolding;
  ...
  public Set<ReserveHis> getBelongToReserve()
  {
    return this.belongToReserve;
  }
  
  public void setBelongToReserve(Set<ReserveHis> paramSet)
  {
    this.belongToReserve = paramSet;
  }
  
  public Set<HoldingHis> getBelongToHolding()
  {
    return this.belongToHolding;
  }
  
  public void setBelongToHolding(Set<HoldingHis> paramSet)
  {
    this.belongToHolding = paramSet;
  }
  
  public Set<TradeGoodsPropertyHis> getTradeGoodsProperties()
  {
    return this.tradeGoodsProperties;
  }
  
  public void setTradeGoodsProperties(Set<TradeGoodsPropertyHis> paramSet)
  {
