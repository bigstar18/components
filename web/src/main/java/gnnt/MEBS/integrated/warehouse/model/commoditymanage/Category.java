package gnnt.MEBS.integrated.warehouse.model.commoditymanage;
  ...
  extends StandardModel
{
  ...
  private String note;
  @ClassDiscription(name="分类类型", description="")
  private String type;
  ...
  {
    return new StandardModel.PrimaryInfo(this, "categoryId", this.categoryId);
  }
