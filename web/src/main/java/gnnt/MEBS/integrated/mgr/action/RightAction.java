...
public class RightAction extends StandardAction {
	...
	public String saveUserRight() {
		...
		try {
			Object localObject1 = this.request.getParameter("userId");
			...
			if (localObject1 != null) {
				if (((ReturnValue) localObject1).getResult() > 0) {
					writeOperateLog(1011, str, 1, ((ReturnValue) localObject1).getInfo());
				} else {
					writeOperateLog(1011, str, 0, ((ReturnValue) localObject1).getInfo());
				}
			}
