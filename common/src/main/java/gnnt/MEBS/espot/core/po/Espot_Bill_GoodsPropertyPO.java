 ...
 * @version 1.0
 */
public class Espot_Bill_GoodsPropertyPO extends Clone implements Serializable {
	...
	public Espot_Bill_GoodsPropertyPO() {
	}
	...
	public String toString() {
		...
		sb.append("[long |").append("propertyTypeID|").append(
				this.propertyTypeID).append("]\n");
		sb.append("]");
		return sb.toString();
	}
}