...
public class Server
{
    ...
    throws Exception
  {
    ...
    int i = Tool.strToInt(GnntBeanFactory.getConfig("selfConfigID"), 64536);
    ...
    if ((localLogonConfigPO.getDataPort() != null) && (localLogonConfigPO.getDataPort().intValue() > 0) && (RMISocketFactory.getSocketFactory() == null)) {
      try
      {
    ...
    localStringBuilder.append("rmi://").append(localLogonConfigPO.getHostIP()).append(":").append(localLogonConfigPO.getPort()).append("/").append(localLogonConfigPO.getServiceName()).append("LogonService");
